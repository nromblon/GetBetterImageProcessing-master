...
//        return imageToThreshold;
    ...
    public static Rect findReferenceObjectRect(Mat imageMat,ImageView imageView){
...
//        IPUtils.basicTresholdedForView(mat_startImage);
        mat_startImage = IPUtils.basicThresholdAlgo(mat_startImage);
